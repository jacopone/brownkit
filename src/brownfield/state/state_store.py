...
class StateStore:
    ...
    def __init__(self, state_path: Path):
        ...
        # Auto-migrate old brownfield-state.json to state.json if needed
        migrate_state_file(memory_dir)

        # Always use state.json (Spec-Kit compatible name)
    ...
    def detect_regression(self, state: BrownfieldState) -> ReEntryEvent | None:
        """
    ...
    def record_re_entry(self, state: BrownfieldState, event: ReEntryEvent) -> None:
        """
    ...
    def resolve_re_entry(self, state: BrownfieldState, event_index: int) -> None:
        """
