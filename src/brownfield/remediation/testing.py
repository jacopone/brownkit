...
class TestingBootstrapper:
    ...
    def bootstrap(
        self,
        core_modules: Optional[list[Path]] = None,
    ...
    def _create_smoke_test(self, module_path: Path) -> Optional[Path]:
        """
    ...
    def _generate_smoke_test_content(self, module_path: Path) -> str:
        ...
        lines = [
            '"""Smoke tests for {}."""'.format(module_path.stem),
            "",
            "import pytest",
    ...
    def _create_contract_test(
        self, module_path: Path, contract_test_dir: Path
    ) -> Optional[Path]:
        """
