...
class BrownfieldConfig:
    ...
    @staticmethod
    def get_forced_language() -> Optional[str]:
    ...
    def get_state_path(project_root: Optional[Path] = None) -> Path:
        ...
        Returns:
            Full path to brownfield-state.json
        """
        state_dir = BrownfieldConfig.get_state_dir(project_root)
        return state_dir / "brownfield-state.json"

    @staticmethod
    def get_checkpoint_dir(project_root: Optional[Path] = None) -> Path:
