...
class GraduationOrchestrator:
    ...
    def __init__(self, project_root: Optional[Path] = None):
        ...
        if self.state.current_phase != Phase.VALIDATION:
            raise ValueError(
                f"Cannot graduate from phase {self.state.current_phase}. "
    ...
    def execute(self) -> GraduationResult:
        ...
        # Step 5: Update state to GRADUATED
    ...
    def _generate_constitution(self) -> Path:
        ...
        md += f"**Status**: Graduated from Brownfield Workflow\n\n"
...
""",
    ...
    def _generate_graduation_report(
        ...
        md += f"**Status**: ✅ Successfully transitioned to Speckit-ready state\n\n"
