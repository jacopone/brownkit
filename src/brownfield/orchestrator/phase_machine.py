...
class PhaseOrchestrator:
    ...
    def can_advance_to(self, next_phase: Phase) -> tuple[bool, str | None]:
        ...
        if unmet_requirements:
            return False, (f"Cannot advance to {next_phase.value}. Unmet requirements: {', '.join(unmet_requirements)}")
