    ...
    try:
        ...
        if output_json:
            output = {
                ...
                "recommended_phase": result.recommended_phase.value if result.recommended_phase else None,
            ...
            if result.all_passed:
                ...
                console.print(f"  Run: [yellow]brownfield remediate --phase {result.recommended_phase.value}[/yellow]")
