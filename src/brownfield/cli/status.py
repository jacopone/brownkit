...
def status(output_json: bool, verbose: bool):
    ...
    if output_json:
        status_data = {
            ...
            "baseline_metrics": {
                ...
                "lines_of_code": state.baseline_metrics.lines_of_code,
            },
            "current_metrics": {
                ...
                "lines_of_code": state.current_metrics.lines_of_code,
            },
    ...
    emoji = phase_emoji.get(state.current_phase.value, "📌")
    console.print(f"[bold]Current Phase:[/bold] {emoji} {state.current_phase.value.upper()}")
    ...
    # Lines of code
    baseline_loc = state.baseline_metrics.lines_of_code or 0
    current_loc = state.current_metrics.lines_of_code or 0
    ...
    if not state.graduated:
        ...
        next_command = phase_commands.get(state.current_phase.value, "brownfield assess")
