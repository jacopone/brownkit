...
class TestAssessmentCommand:
    ...
    def test_assess_creates_directory_structure(self, cli_runner, python_project, monkeypatch):
        ...
        # Check for state.json (new name) or brownfield-state.json (legacy)
        assert (state_dir / "state.json").exists() or (state_dir / "brownfield-state.json").exists()
...
class TestEnvironmentVariableConfiguration:
    ...
    def test_custom_state_dir(self, cli_runner, python_project, tmp_path, monkeypatch):
        ...
        # Check for state.json (new name) or brownfield-state.json (legacy)
        assert (custom_state / "state.json").exists() or (custom_state / "brownfield-state.json").exists()
