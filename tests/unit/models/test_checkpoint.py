...
class TestPhaseCheckpoint:
    ...
    @pytest.fixture
    def sample_completed_tasks(self):
    ...
    def test_checkpoint_creation(self, sample_completed_tasks, sample_pending_tasks):
    ...
    def test_checkpoint_completed_tasks_property(self, sample_completed_tasks, sample_pending_tasks):
        """Test completed_tasks returns only completed tasks."""
        checkpoint = PhaseCheckpoint(
            phase=Phase.TESTING,
            completed_tasks=sample_completed_tasks,
            pending_tasks=sample_pending_tasks,
    ...
    def test_checkpoint_pending_tasks_property(self, sample_completed_tasks, sample_pending_tasks):
        """Test pending_tasks returns only incomplete tasks."""
        checkpoint = PhaseCheckpoint(
            phase=Phase.TESTING,
            completed_tasks=sample_completed_tasks,
            pending_tasks=sample_pending_tasks,
    ...
    def test_checkpoint_progress_percentage(self, sample_completed_tasks, sample_pending_tasks):
    ...
    def test_mark_task_complete(self, sample_completed_tasks, sample_pending_tasks):
    ...
    def test_mark_task_complete_updates_checkpoint_time(self, sample_completed_tasks, sample_pending_tasks):
        ...
        original_time = checkpoint.timestamp

        time.sleep(0.1)
        checkpoint.mark_task_complete("task_3")

        assert checkpoint.timestamp > original_time

    def test_detect_interruption_not_interrupted(self, sample_completed_tasks, sample_pending_tasks):
