...
class TestStateMigration:
    ...
    def test_check_migration_needed_detects_old_file(self, temp_memory_dir, old_state_file):
    ...
    def test_check_migration_needed_none_after_migration(self, temp_memory_dir, old_state_file):
